    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label><?php echo lang('Client.form.staff'); ?></label>
                        <input type="text" value="<?php echo $ticket->staff_name; ?>" class="form-control" readonly>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo lang('Admin.form.' . $ticket->priority_name); ?>" class="form-control" readonly>
                    </div>
                </div>
            </div>
        </div>
