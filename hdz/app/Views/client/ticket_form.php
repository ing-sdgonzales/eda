...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="form-group">
                <label><?php echo lang('Admin.form.staff'); ?><span class="text-danger">*</span></label>
                <select name="staff" class="form-control custom-select">
                    <?php
                    if (isset($staff)) {
                        foreach ($staff as $item) {
                            if ($item->id == set_value('staff')) {
            ...
            <div class="form-group">
                <label><?php echo lang('Admin.form.priority'); ?><span class="text-danger">*</span></label>
