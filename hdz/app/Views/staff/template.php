        ...
        <div class="row">
            ...
            <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
                <div class="main-navbar">
                    <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0" style="height: 120px;">
                        <a class="navbar-brand w-100 h-100 mr-0" href="<?php echo site_url(route_to('staff_tickets')); ?>" style="line-height: 25px;">
                            <div class="d-table m-auto">
                                <img id="main-logo" class="d-inline-block" style="max-width: 90px;" src="<?php echo base_url('assets/helpdeskz/images/logoalt.svg'); ?>">
                            </div>
                        </a>
